...
def main():
    ...
    parser.add_argument('--name', type=str, default='Prepro',
    ...
    root = '/media/user_home2/vision2020_01/jfmontenegro/Proyecto/Proyecto/'
    train_file = 'train_pair.csv'
    test_file = 'val_pair.csv'
...
def test(args, model, loader, save_path, test_file):
    ...
    for idx in range(len(patients)):
        ...
        Read_data.save_image(prediction, os.path.join(save_path, os.path.basename(name)), affine)
